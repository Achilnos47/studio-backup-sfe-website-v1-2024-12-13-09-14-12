...
if ( !has_post_thumbnail() ) {
	...
	echo wp_kses($prefix.$quote.$sufix, wanium_allowed_tags());
} else {
	...
	echo '<div class="shadow-caption-overlay"><div class="shadow-caption-inner">'.wp_kses($prefix.$quote.$sufix, wanium_allowed_tags()).'</div></div></div>';
}