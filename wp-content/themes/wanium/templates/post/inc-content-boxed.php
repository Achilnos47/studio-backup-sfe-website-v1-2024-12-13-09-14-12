...
<div class="boxed-intro overflow-hidden bg-white heavy-shadow zoom-hover">
    ...
    if( 'quote' == $format || 'link' == $format ) {
            ...
            <div class="intro-image overflow-hidden relative">
                <a href="<?php the_permalink(); ?>">
                    <?php if ( has_post_thumbnail() ) : ?>
                        <?php the_post_thumbnail( 'wanium_grid', array() ); ?>
        ...
        <div class="intro-content">
            <div class="widgetsubtitle mb16"><span class="inline-block inline-cat"><?php the_category( ',</span><span class="inline-block inline-cat">' ) ?></span></div>
            <a href="<?php the_permalink(); ?>">
