...
// BEGIN ROW
echo 'stretch_row' == $full_width ? '<div ' . implode( ' ', $wrapper_attributes ) . '>' : 
...
echo 'video' == $tlg_bg_video_style ? '<div class="video-background-content"><video autoplay muted loop><source src="'. esc_url($tlg_bg_video_url) .'" type="video/mp4"><source src="'. esc_url($tlg_bg_video_url_2) .'" type="video/webm"></video></div><div '.$style_overlay.' class="background-overlay"></div>' : '';
